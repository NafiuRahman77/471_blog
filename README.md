...
| Nishimoto    | -                                | -        | -        | 0.727 ± 0.04  | -                                | 0.116 ± 0.09 | 8.012 ± 2.31       |          |
| Wen        | -                                | 0.166 ± 0.02 | -    | 0.758 ± 0.03  | 0.070 ± 0.01                    | 0.114 ± 0.15 | 7.646 ± 3.48       |          |
| Wang        | 0.773 ± 0.03                     | -        | 0.402 ± 0.41 | 0.713 ± 0.04 | -                                | 0.118 ± 0.08 | **11.432 ± 2.42** |          |
| Kupershmidt | 0.771 ± 0.03                     | -        | 0.386 ± 0.47 | 0.764 ± 0.03 | 0.179 ± 0.02                    | 0.135 ± 0.08 | 8.761 ± 2.22       |          |
| MinD-Video   | **0.839 ± 0.03**                 | 0.197 ± 0.02 | 0.408 ± 0.46 | 0.796 ± 0.03 | 0.174 ± 0.03                    | 0.171 ± 0.08 | 8.662 ± 1.52       |          |
| **NeuroClips**       | 0.834 ± 0.03                     | **0.220 ± 0.01** | **0.738 ± 0.17** | **0.806 ± 0.03** | **0.203 ± 0.01** | **0.390 ± 0.08** | 9.211 ± 1.46  |
| Subject 1        | 0.830 ± 0.03                     | 0.208 ± 0.01 | 0.736 ± 0.12 | 0.799 ± 0.03 | 0.187 ± 0.01                    | **0.392 ± 0.08** | **9.226 ± 1.42** |
| Subject 2        | 0.837 ± 0.03                   | 0.230 ± 0.01 | 0.742 ± 0.19 | 0.811 ± 0.03 | 0.210 ± 0.01                  | **0.392 ± 0.08** | **9.336 ± 1.52** |
